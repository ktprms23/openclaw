...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/tool-result-char-estimator.ts`.
 *
...
typealias MessageCharEstimateCache = Any /* WeakMap<AgentMessage, number> */

val CHARS_PER_TOKEN_ESTIMATE: Any? = TODO("Port constant CHARS_PER_TOKEN_ESTIMATE")

val TOOL_RESULT_CHARS_PER_TOKEN_ESTIMATE: Any? = TODO("Port constant TOOL_RESULT_CHARS_PER_TOKEN_ESTIMATE")

fun isToolResultMessage(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isToolResultMessage from src/agents/pi-embedded-runner/tool-result-char-estimator.ts")
}

fun getToolResultText(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function getToolResultText from src/agents/pi-embedded-runner/tool-result-char-estimator.ts")
}

fun createMessageCharEstimateCache(/* parameters preserved from TypeScript source */): MessageCharEstimateCache {
    TODO("Port runtime function createMessageCharEstimateCache from src/agents/pi-embedded-runner/tool-result-char-estimator.ts")
}

fun estimateMessageCharsCached(/* parameters preserved from TypeScript source */): Double {
    TODO("Port runtime function estimateMessageCharsCached from src/agents/pi-embedded-runner/tool-result-char-estimator.ts")
}

fun estimateContextChars(/* parameters preserved from TypeScript source */): Double {
    TODO("Port runtime function estimateContextChars from src/agents/pi-embedded-runner/tool-result-char-estimator.ts")
}

fun invalidateMessageCharsCacheEntry(/* parameters preserved from TypeScript source */): Unit {
    TODO("Port runtime function invalidateMessageCharsCacheEntry from src/agents/pi-embedded-runner/tool-result-char-estimator.ts")
}
