...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/tool-result-context-guard.ts`.
 *
...
val CONTEXT_LIMIT_TRUNCATION_NOTICE: Any? = TODO("Port constant CONTEXT_LIMIT_TRUNCATION_NOTICE")

val PREEMPTIVE_TOOL_RESULT_COMPACTION_PLACEHOLDER: Any? = TODO("Port constant PREEMPTIVE_TOOL_RESULT_COMPACTION_PLACEHOLDER")

val PREEMPTIVE_CONTEXT_OVERFLOW_MESSAGE: Any? = TODO("Port constant PREEMPTIVE_CONTEXT_OVERFLOW_MESSAGE")

fun installToolResultContextGuard(/* parameters preserved from TypeScript source */): () => void {
    TODO("Port runtime function installToolResultContextGuard from src/agents/pi-embedded-runner/tool-result-context-guard.ts")
}
