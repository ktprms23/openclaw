...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/compaction-safety-timeout.ts`.
 *
...
val EMBEDDED_COMPACTION_TIMEOUT_MS: Any? = TODO("Port constant EMBEDDED_COMPACTION_TIMEOUT_MS")

fun resolveCompactionTimeoutMs(/* parameters preserved from TypeScript source */): Double {
    TODO("Port runtime function resolveCompactionTimeoutMs from src/agents/pi-embedded-runner/compaction-safety-timeout.ts")
}
