...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/compact.ts`.
 *
...
typealias CompactEmbeddedPiSessionParams = Any /* complex TypeScript alias; see reference block below */

fun compactEmbeddedPiSessionDirect(/* parameters preserved from TypeScript source */): EmbeddedPiCompactResult {
    TODO("Port runtime function compactEmbeddedPiSessionDirect from src/agents/pi-embedded-runner/compact.ts")
}

fun compactEmbeddedPiSession(/* parameters preserved from TypeScript source */): EmbeddedPiCompactResult {
    TODO("Port runtime function compactEmbeddedPiSession from src/agents/pi-embedded-runner/compact.ts")
}
