...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/moonshot-stream-wrappers.ts`.
 *
...
fun shouldApplySiliconFlowThinkingOffCompat(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function shouldApplySiliconFlowThinkingOffCompat from src/agents/pi-embedded-runner/moonshot-stream-wrappers.ts")
}

fun shouldApplyMoonshotPayloadCompat(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function shouldApplyMoonshotPayloadCompat from src/agents/pi-embedded-runner/moonshot-stream-wrappers.ts")
}

fun createSiliconFlowThinkingWrapper(/* parameters preserved from TypeScript source */): StreamFn {
    TODO("Port runtime function createSiliconFlowThinkingWrapper from src/agents/pi-embedded-runner/moonshot-stream-wrappers.ts")
}

fun resolveMoonshotThinkingType(/* parameters preserved from TypeScript source */): Any /* MoonshotThinkingType | undefined */ {
    TODO("Port runtime function resolveMoonshotThinkingType from src/agents/pi-embedded-runner/moonshot-stream-wrappers.ts")
}

fun createMoonshotThinkingWrapper(/* parameters preserved from TypeScript source */): StreamFn {
    TODO("Port runtime function createMoonshotThinkingWrapper from src/agents/pi-embedded-runner/moonshot-stream-wrappers.ts")
}
