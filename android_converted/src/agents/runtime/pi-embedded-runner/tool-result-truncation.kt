...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/tool-result-truncation.ts`.
 *
...
val HARD_MAX_TOOL_RESULT_CHARS: Any? = TODO("Port constant HARD_MAX_TOOL_RESULT_CHARS")

fun truncateToolResultText(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function truncateToolResultText from src/agents/pi-embedded-runner/tool-result-truncation.ts")
}

fun calculateMaxToolResultChars(/* parameters preserved from TypeScript source */): Double {
    TODO("Port runtime function calculateMaxToolResultChars from src/agents/pi-embedded-runner/tool-result-truncation.ts")
}

fun getToolResultTextLength(/* parameters preserved from TypeScript source */): Double {
    TODO("Port runtime function getToolResultTextLength from src/agents/pi-embedded-runner/tool-result-truncation.ts")
}

fun truncateToolResultMessage(/* parameters preserved from TypeScript source */): AgentMessage {
    TODO("Port runtime function truncateToolResultMessage from src/agents/pi-embedded-runner/tool-result-truncation.ts")
}

fun truncateOversizedToolResultsInSession(/* parameters preserved from TypeScript source */): Promise< {
    TODO("Port runtime function truncateOversizedToolResultsInSession from src/agents/pi-embedded-runner/tool-result-truncation.ts")
}

fun truncateOversizedToolResultsInMessages(/* parameters preserved from TypeScript source */):  {
    TODO("Port runtime function truncateOversizedToolResultsInMessages from src/agents/pi-embedded-runner/tool-result-truncation.ts")
}

fun isOversizedToolResult(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isOversizedToolResult from src/agents/pi-embedded-runner/tool-result-truncation.ts")
}

fun sessionLikelyHasOversizedToolResults(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function sessionLikelyHasOversizedToolResults from src/agents/pi-embedded-runner/tool-result-truncation.ts")
}
