...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/google.ts`.
 *
...
typealias CompactionFailureListener = Any /* (reason: string) => void */

fun findUnsupportedSchemaKeywords(/* parameters preserved from TypeScript source */): List<String> {
    TODO("Port runtime function findUnsupportedSchemaKeywords from src/agents/pi-embedded-runner/google.ts")
}

fun logToolSchemasForGoogle(/* parameters preserved from TypeScript source */): Unit {
    TODO("Port runtime function logToolSchemasForGoogle from src/agents/pi-embedded-runner/google.ts")
}

fun onUnhandledCompactionFailure(/* parameters preserved from TypeScript source */): () => void {
    TODO("Port runtime function onUnhandledCompactionFailure from src/agents/pi-embedded-runner/google.ts")
}

fun applyGoogleTurnOrderingFix(/* parameters preserved from TypeScript source */):  {
    TODO("Port runtime function applyGoogleTurnOrderingFix from src/agents/pi-embedded-runner/google.ts")
}

fun sanitizeSessionHistory(/* parameters preserved from TypeScript source */): List<AgentMessage> {
    TODO("Port runtime function sanitizeSessionHistory from src/agents/pi-embedded-runner/google.ts")
}
