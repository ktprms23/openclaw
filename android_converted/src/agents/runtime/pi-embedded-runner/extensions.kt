...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/extensions.ts`.
 *
...
fun buildEmbeddedExtensionFactories(/* parameters preserved from TypeScript source */): List<ExtensionFactory> {
    TODO("Port runtime function buildEmbeddedExtensionFactories from src/agents/pi-embedded-runner/extensions.ts")
}
