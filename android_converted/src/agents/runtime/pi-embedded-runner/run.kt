...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/run.ts`.
 *
...
fun runEmbeddedPiAgent(/* parameters preserved from TypeScript source */): EmbeddedPiRunResult {
    TODO("Port runtime function runEmbeddedPiAgent from src/agents/pi-embedded-runner/run.ts")
}
