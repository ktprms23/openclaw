...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/run/images.ts`.
 *
...
fun detectImageReferences(/* parameters preserved from TypeScript source */): List<DetectedImageRef> {
    TODO("Port runtime function detectImageReferences from src/agents/pi-embedded-runner/run/images.ts")
}

fun loadImageFromRef(/* parameters preserved from TypeScript source */): Any /* ImageContent | null */ {
    TODO("Port runtime function loadImageFromRef from src/agents/pi-embedded-runner/run/images.ts")
}

fun modelSupportsImages(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function modelSupportsImages from src/agents/pi-embedded-runner/run/images.ts")
}

fun detectAndLoadPromptImages(/* parameters preserved from TypeScript source */): Promise< {
    TODO("Port runtime function detectAndLoadPromptImages from src/agents/pi-embedded-runner/run/images.ts")
}
