...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/run/attempt.ts`.
 *
...
fun isOllamaCompatProvider(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isOllamaCompatProvider from src/agents/pi-embedded-runner/run/attempt.ts")
}

fun resolveOllamaCompatNumCtxEnabled(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function resolveOllamaCompatNumCtxEnabled from src/agents/pi-embedded-runner/run/attempt.ts")
}

fun shouldInjectOllamaCompatNumCtx(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function shouldInjectOllamaCompatNumCtx from src/agents/pi-embedded-runner/run/attempt.ts")
}

fun wrapOllamaCompatNumCtx(/* parameters preserved from TypeScript source */): StreamFn {
    TODO("Port runtime function wrapOllamaCompatNumCtx from src/agents/pi-embedded-runner/run/attempt.ts")
}

fun wrapStreamFnTrimToolCallNames(/* parameters preserved from TypeScript source */): StreamFn {
    TODO("Port runtime function wrapStreamFnTrimToolCallNames from src/agents/pi-embedded-runner/run/attempt.ts")
}

fun wrapStreamFnRepairMalformedToolCallArguments(/* parameters preserved from TypeScript source */): StreamFn {
    TODO("Port runtime function wrapStreamFnRepairMalformedToolCallArguments from src/agents/pi-embedded-runner/run/attempt.ts")
}

fun decodeHtmlEntitiesInObject(/* parameters preserved from TypeScript source */): Any? {
    TODO("Port runtime function decodeHtmlEntitiesInObject from src/agents/pi-embedded-runner/run/attempt.ts")
}

fun resolvePromptBuildHookResult(/* parameters preserved from TypeScript source */): PluginHookBeforePromptBuildResult {
    TODO("Port runtime function resolvePromptBuildHookResult from src/agents/pi-embedded-runner/run/attempt.ts")
}

fun composeSystemPromptWithHookContext(/* parameters preserved from TypeScript source */): Any /* string | undefined */ {
    TODO("Port runtime function composeSystemPromptWithHookContext from src/agents/pi-embedded-runner/run/attempt.ts")
}

fun resolvePromptModeForSession(/* parameters preserved from TypeScript source */): Any /* "minimal" | "full" */ {
    TODO("Port runtime function resolvePromptModeForSession from src/agents/pi-embedded-runner/run/attempt.ts")
}

fun resolveAttemptFsWorkspaceOnly(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function resolveAttemptFsWorkspaceOnly from src/agents/pi-embedded-runner/run/attempt.ts")
}

fun prependSystemPromptAddition(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function prependSystemPromptAddition from src/agents/pi-embedded-runner/run/attempt.ts")
}

fun buildAfterTurnRuntimeContext(/* parameters preserved from TypeScript source */): Partial<CompactEmbeddedPiSessionParams> {
    TODO("Port runtime function buildAfterTurnRuntimeContext from src/agents/pi-embedded-runner/run/attempt.ts")
}

fun runEmbeddedAttempt(/* parameters preserved from TypeScript source */): EmbeddedRunAttemptResult {
    TODO("Port runtime function runEmbeddedAttempt from src/agents/pi-embedded-runner/run/attempt.ts")
}
