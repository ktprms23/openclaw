...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/run/payloads.ts`.
 *
...
fun buildEmbeddedRunPayloads(/* parameters preserved from TypeScript source */): Array< {
    TODO("Port runtime function buildEmbeddedRunPayloads from src/agents/pi-embedded-runner/run/payloads.ts")
}
