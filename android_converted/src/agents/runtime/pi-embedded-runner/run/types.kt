...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/run/types.ts`.
 *
...
typealias EmbeddedRunAttemptResult = Any /* complex TypeScript alias; see reference block below */
