...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/run/params.ts`.
 *
...
typealias ClientToolDefinition = Any /* complex TypeScript alias; see reference block below */

typealias RunEmbeddedPiAgentParams = Any /* complex TypeScript alias; see reference block below */
