...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/types.ts`.
 *
...
typealias EmbeddedPiAgentMeta = Any /* complex TypeScript alias; see reference block below */

typealias EmbeddedPiRunMeta = Any /* complex TypeScript alias; see reference block below */

typealias EmbeddedPiRunResult = Any /* complex TypeScript alias; see reference block below */

typealias EmbeddedPiCompactResult = Any /* complex TypeScript alias; see reference block below */

typealias EmbeddedSandboxInfo = Any /* complex TypeScript alias; see reference block below */
