...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/openrouter-model-capabilities.ts`.
 *
...
fun ensureOpenRouterModelCache(/* parameters preserved from TypeScript source */): Unit {
    TODO("Port runtime function ensureOpenRouterModelCache from src/agents/pi-embedded-runner/openrouter-model-capabilities.ts")
}

fun loadOpenRouterModelCapabilities(/* parameters preserved from TypeScript source */): Unit {
    TODO("Port runtime function loadOpenRouterModelCapabilities from src/agents/pi-embedded-runner/openrouter-model-capabilities.ts")
}

fun getOpenRouterModelCapabilities(/* parameters preserved from TypeScript source */): Any /* OpenRouterModelCapabilities | undefined */ {
    TODO("Port runtime function getOpenRouterModelCapabilities from src/agents/pi-embedded-runner/openrouter-model-capabilities.ts")
}
