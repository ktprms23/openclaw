...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-runner/model.ts`.
 *
...
fun buildInlineProviderModels(/* parameters preserved from TypeScript source */): List<InlineModelEntry> {
    TODO("Port runtime function buildInlineProviderModels from src/agents/pi-embedded-runner/model.ts")
}

fun resolveModelWithRegistry(/* parameters preserved from TypeScript source */): Any /* Model<Api> | undefined */ {
    TODO("Port runtime function resolveModelWithRegistry from src/agents/pi-embedded-runner/model.ts")
}

fun resolveModel(/* parameters preserved from TypeScript source */):  {
    TODO("Port runtime function resolveModel from src/agents/pi-embedded-runner/model.ts")
}

fun resolveModelAsync(/* parameters preserved from TypeScript source */): Promise< {
    TODO("Port runtime function resolveModelAsync from src/agents/pi-embedded-runner/model.ts")
}
