...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-subscribe.tools.ts`.
 *
...
fun sanitizeToolResult(/* parameters preserved from TypeScript source */): Any? {
    TODO("Port runtime function sanitizeToolResult from src/agents/pi-embedded-subscribe.tools.ts")
}

fun extractToolResultText(/* parameters preserved from TypeScript source */): Any /* string | undefined */ {
    TODO("Port runtime function extractToolResultText from src/agents/pi-embedded-subscribe.tools.ts")
}

fun isToolResultMediaTrusted(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isToolResultMediaTrusted from src/agents/pi-embedded-subscribe.tools.ts")
}

fun filterToolResultMediaUrls(/* parameters preserved from TypeScript source */): List<String> {
    TODO("Port runtime function filterToolResultMediaUrls from src/agents/pi-embedded-subscribe.tools.ts")
}

fun extractToolResultMediaPaths(/* parameters preserved from TypeScript source */): List<String> {
    TODO("Port runtime function extractToolResultMediaPaths from src/agents/pi-embedded-subscribe.tools.ts")
}

fun isToolResultError(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isToolResultError from src/agents/pi-embedded-subscribe.tools.ts")
}

fun extractToolErrorMessage(/* parameters preserved from TypeScript source */): Any /* string | undefined */ {
    TODO("Port runtime function extractToolErrorMessage from src/agents/pi-embedded-subscribe.tools.ts")
}

fun extractMessagingToolSend(/* parameters preserved from TypeScript source */): Any /* MessagingToolSend | undefined */ {
    TODO("Port runtime function extractMessagingToolSend from src/agents/pi-embedded-subscribe.tools.ts")
}
