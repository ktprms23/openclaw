...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-utils.ts`.
 *
...
fun isAssistantMessage(/* parameters preserved from TypeScript source */): msg is AssistantMessage {
    TODO("Port runtime function isAssistantMessage from src/agents/pi-embedded-utils.ts")
}

fun stripMinimaxToolCallXml(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function stripMinimaxToolCallXml from src/agents/pi-embedded-utils.ts")
}

fun stripModelSpecialTokens(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function stripModelSpecialTokens from src/agents/pi-embedded-utils.ts")
}

fun stripDowngradedToolCallText(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function stripDowngradedToolCallText from src/agents/pi-embedded-utils.ts")
}

fun stripThinkingTagsFromText(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function stripThinkingTagsFromText from src/agents/pi-embedded-utils.ts")
}

fun extractAssistantText(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function extractAssistantText from src/agents/pi-embedded-utils.ts")
}

fun extractAssistantThinking(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function extractAssistantThinking from src/agents/pi-embedded-utils.ts")
}

fun formatReasoningMessage(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function formatReasoningMessage from src/agents/pi-embedded-utils.ts")
}

fun splitThinkingTaggedText(/* parameters preserved from TypeScript source */): Any /* ThinkTaggedSplitBlock[] | null */ {
    TODO("Port runtime function splitThinkingTaggedText from src/agents/pi-embedded-utils.ts")
}

fun promoteThinkingTagsToBlocks(/* parameters preserved from TypeScript source */): Unit {
    TODO("Port runtime function promoteThinkingTagsToBlocks from src/agents/pi-embedded-utils.ts")
}

fun extractThinkingFromTaggedText(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function extractThinkingFromTaggedText from src/agents/pi-embedded-utils.ts")
}

fun extractThinkingFromTaggedStream(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function extractThinkingFromTaggedStream from src/agents/pi-embedded-utils.ts")
}

fun inferToolMetaFromArgs(/* parameters preserved from TypeScript source */): Any /* string | undefined */ {
    TODO("Port runtime function inferToolMetaFromArgs from src/agents/pi-embedded-utils.ts")
}
