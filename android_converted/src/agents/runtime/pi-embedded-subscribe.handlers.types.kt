...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-subscribe.handlers.types.ts`.
 *
...
typealias EmbeddedSubscribeLogger = Any /* complex TypeScript alias; see reference block below */

data class ToolErrorSummary(
    val toolName: String = TODO("Port default"),
    val meta: String? = TODO("Port default"),
    val error: String? = TODO("Port default"),
    val mutatingAction: Boolean? = TODO("Port default"),
    val actionFingerprint: String? = TODO("Port default")
)
...
typealias EmbeddedPiSubscribeState = Any /* complex TypeScript alias; see reference block below */

typealias EmbeddedPiSubscribeContext = Any /* complex TypeScript alias; see reference block below */

typealias ToolHandlerContext = Any /* complex TypeScript alias; see reference block below */
