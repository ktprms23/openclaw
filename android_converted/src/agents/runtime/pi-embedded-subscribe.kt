...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-subscribe.ts`.
 *
...
fun subscribeEmbeddedPiSession(/* parameters preserved from TypeScript source */): Unit {
    TODO("Port runtime function subscribeEmbeddedPiSession from src/agents/pi-embedded-subscribe.ts")
}
