...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-error-observation.ts`.
 *
...
fun sanitizeForConsole(/* parameters preserved from TypeScript source */): Any /* string | undefined */ {
    TODO("Port runtime function sanitizeForConsole from src/agents/pi-embedded-error-observation.ts")
}

fun buildApiErrorObservationFields(/* parameters preserved from TypeScript source */):  {
    TODO("Port runtime function buildApiErrorObservationFields from src/agents/pi-embedded-error-observation.ts")
}

fun buildTextObservationFields(/* parameters preserved from TypeScript source */):  {
    TODO("Port runtime function buildTextObservationFields from src/agents/pi-embedded-error-observation.ts")
}
