...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-block-chunker.ts`.
 *
...
data class BlockReplyChunking(
    val minChars: Double = TODO("Port default"),
    val maxChars: Double = TODO("Port default"),
    val breakPreference: Any /* "paragraph" | "newline" | "sentence" */? = TODO("Port default"),
    val flushOnParagraph: Boolean? = TODO("Port default")
)

class EmbeddedBlockChunker {
    /* Runtime implementation preserved in the TypeScript reference block below. */
}
