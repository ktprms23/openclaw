...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-helpers/images.ts`.
 *
...
fun isEmptyAssistantMessageContent(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isEmptyAssistantMessageContent from src/agents/pi-embedded-helpers/images.ts")
}

fun sanitizeSessionMessagesImages(/* parameters preserved from TypeScript source */): List<AgentMessage> {
    TODO("Port runtime function sanitizeSessionMessagesImages from src/agents/pi-embedded-helpers/images.ts")
}
