...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-helpers/bootstrap.ts`.
 *
...
val DEFAULT_BOOTSTRAP_MAX_CHARS: Any? = TODO("Port constant DEFAULT_BOOTSTRAP_MAX_CHARS")

val DEFAULT_BOOTSTRAP_TOTAL_MAX_CHARS: Any? = TODO("Port constant DEFAULT_BOOTSTRAP_TOTAL_MAX_CHARS")

val DEFAULT_BOOTSTRAP_PROMPT_TRUNCATION_WARNING_MODE: Any? = TODO("Port constant DEFAULT_BOOTSTRAP_PROMPT_TRUNCATION_WARNING_MODE")

fun resolveBootstrapMaxChars(/* parameters preserved from TypeScript source */): Double {
    TODO("Port runtime function resolveBootstrapMaxChars from src/agents/pi-embedded-helpers/bootstrap.ts")
}

fun resolveBootstrapTotalMaxChars(/* parameters preserved from TypeScript source */): Double {
    TODO("Port runtime function resolveBootstrapTotalMaxChars from src/agents/pi-embedded-helpers/bootstrap.ts")
}

fun resolveBootstrapPromptTruncationWarningMode(/* parameters preserved from TypeScript source */): Any /* "off" | "once" | "always" */ {
    TODO("Port runtime function resolveBootstrapPromptTruncationWarningMode from src/agents/pi-embedded-helpers/bootstrap.ts")
}

fun ensureSessionHeader(/* parameters preserved from TypeScript source */): Unit {
    TODO("Port runtime function ensureSessionHeader from src/agents/pi-embedded-helpers/bootstrap.ts")
}

fun buildBootstrapContextFiles(/* parameters preserved from TypeScript source */): List<EmbeddedContextFile> {
    TODO("Port runtime function buildBootstrapContextFiles from src/agents/pi-embedded-helpers/bootstrap.ts")
}

fun sanitizeGoogleTurnOrdering(/* parameters preserved from TypeScript source */): List<AgentMessage> {
    TODO("Port runtime function sanitizeGoogleTurnOrdering from src/agents/pi-embedded-helpers/bootstrap.ts")
}
