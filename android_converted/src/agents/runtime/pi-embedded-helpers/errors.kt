...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-helpers/errors.ts`.
 *
...
data class ApiErrorInfo(
    val httpCode: String? = TODO("Port default"),
    val type: String? = TODO("Port default"),
    val message: String? = TODO("Port default"),
    val requestId: String? = TODO("Port default")
)

val BILLING_ERROR_USER_MESSAGE: Any? = TODO("Port constant BILLING_ERROR_USER_MESSAGE")

fun formatBillingErrorMessage(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function formatBillingErrorMessage from src/agents/pi-embedded-helpers/errors.ts")
}

fun isContextOverflowError(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isContextOverflowError from src/agents/pi-embedded-helpers/errors.ts")
}

fun isLikelyContextOverflowError(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isLikelyContextOverflowError from src/agents/pi-embedded-helpers/errors.ts")
}

fun isCompactionFailureError(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isCompactionFailureError from src/agents/pi-embedded-helpers/errors.ts")
}

fun extractObservedOverflowTokenCount(/* parameters preserved from TypeScript source */): Any /* number | undefined */ {
    TODO("Port runtime function extractObservedOverflowTokenCount from src/agents/pi-embedded-helpers/errors.ts")
}

fun isCloudflareOrHtmlErrorPage(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isCloudflareOrHtmlErrorPage from src/agents/pi-embedded-helpers/errors.ts")
}

fun isTransientHttpError(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isTransientHttpError from src/agents/pi-embedded-helpers/errors.ts")
}

fun classifyFailoverReasonFromHttpStatus(/* parameters preserved from TypeScript source */): Any /* FailoverReason | null */ {
    TODO("Port runtime function classifyFailoverReasonFromHttpStatus from src/agents/pi-embedded-helpers/errors.ts")
}

fun getApiErrorPayloadFingerprint(/* parameters preserved from TypeScript source */): Any /* string | null */ {
    TODO("Port runtime function getApiErrorPayloadFingerprint from src/agents/pi-embedded-helpers/errors.ts")
}

fun isRawApiErrorPayload(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isRawApiErrorPayload from src/agents/pi-embedded-helpers/errors.ts")
}

fun parseApiErrorInfo(/* parameters preserved from TypeScript source */): Any /* ApiErrorInfo | null */ {
    TODO("Port runtime function parseApiErrorInfo from src/agents/pi-embedded-helpers/errors.ts")
}

fun formatRawAssistantErrorForUi(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function formatRawAssistantErrorForUi from src/agents/pi-embedded-helpers/errors.ts")
}

fun formatAssistantErrorText(/* parameters preserved from TypeScript source */): Any /* string | undefined */ {
    TODO("Port runtime function formatAssistantErrorText from src/agents/pi-embedded-helpers/errors.ts")
}

fun sanitizeUserFacingText(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function sanitizeUserFacingText from src/agents/pi-embedded-helpers/errors.ts")
}

fun isRateLimitAssistantError(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isRateLimitAssistantError from src/agents/pi-embedded-helpers/errors.ts")
}

fun isMissingToolCallInputError(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isMissingToolCallInputError from src/agents/pi-embedded-helpers/errors.ts")
}

fun isBillingAssistantError(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isBillingAssistantError from src/agents/pi-embedded-helpers/errors.ts")
}

fun parseImageDimensionError(/* parameters preserved from TypeScript source */):  {
    TODO("Port runtime function parseImageDimensionError from src/agents/pi-embedded-helpers/errors.ts")
}

fun isImageDimensionErrorMessage(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isImageDimensionErrorMessage from src/agents/pi-embedded-helpers/errors.ts")
}

fun parseImageSizeError(/* parameters preserved from TypeScript source */):  {
    TODO("Port runtime function parseImageSizeError from src/agents/pi-embedded-helpers/errors.ts")
}

fun isImageSizeError(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isImageSizeError from src/agents/pi-embedded-helpers/errors.ts")
}

fun isCloudCodeAssistFormatError(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isCloudCodeAssistFormatError from src/agents/pi-embedded-helpers/errors.ts")
}

fun isAuthAssistantError(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isAuthAssistantError from src/agents/pi-embedded-helpers/errors.ts")
}

fun isModelNotFoundErrorMessage(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isModelNotFoundErrorMessage from src/agents/pi-embedded-helpers/errors.ts")
}

fun classifyFailoverReason(/* parameters preserved from TypeScript source */): Any /* FailoverReason | null */ {
    TODO("Port runtime function classifyFailoverReason from src/agents/pi-embedded-helpers/errors.ts")
}

fun isFailoverErrorMessage(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isFailoverErrorMessage from src/agents/pi-embedded-helpers/errors.ts")
}

fun isFailoverAssistantError(/* parameters preserved from TypeScript source */): Boolean {
    TODO("Port runtime function isFailoverAssistantError from src/agents/pi-embedded-helpers/errors.ts")
}
