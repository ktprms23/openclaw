...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-helpers/turns.ts`.
 *
...
fun validateGeminiTurns(/* parameters preserved from TypeScript source */): List<AgentMessage> {
    TODO("Port runtime function validateGeminiTurns from src/agents/pi-embedded-helpers/turns.ts")
}

fun mergeConsecutiveUserTurns(/* parameters preserved from TypeScript source */): Extract<AgentMessage, {
    TODO("Port runtime function mergeConsecutiveUserTurns from src/agents/pi-embedded-helpers/turns.ts")
}

fun validateAnthropicTurns(/* parameters preserved from TypeScript source */): List<AgentMessage> {
    TODO("Port runtime function validateAnthropicTurns from src/agents/pi-embedded-helpers/turns.ts")
}
