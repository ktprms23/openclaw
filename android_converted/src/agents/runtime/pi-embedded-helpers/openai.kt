...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-helpers/openai.ts`.
 *
...
fun downgradeOpenAIFunctionCallReasoningPairs(/* parameters preserved from TypeScript source */): List<AgentMessage> {
    TODO("Port runtime function downgradeOpenAIFunctionCallReasoningPairs from src/agents/pi-embedded-helpers/openai.ts")
}

fun downgradeOpenAIReasoningBlocks(/* parameters preserved from TypeScript source */): List<AgentMessage> {
    TODO("Port runtime function downgradeOpenAIReasoningBlocks from src/agents/pi-embedded-helpers/openai.ts")
}
