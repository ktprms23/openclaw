...
/**
 * Phase 1 Kotlin port scaffold for `src/agents/pi-embedded-subscribe.handlers.messages.ts`.
 *
...
fun resolveSilentReplyFallbackText(/* parameters preserved from TypeScript source */): String {
    TODO("Port runtime function resolveSilentReplyFallbackText from src/agents/pi-embedded-subscribe.handlers.messages.ts")
}

fun handleMessageStart(/* parameters preserved from TypeScript source */): Unit {
    TODO("Port runtime function handleMessageStart from src/agents/pi-embedded-subscribe.handlers.messages.ts")
}

fun handleMessageUpdate(/* parameters preserved from TypeScript source */): Unit {
    TODO("Port runtime function handleMessageUpdate from src/agents/pi-embedded-subscribe.handlers.messages.ts")
}

fun handleMessageEnd(/* parameters preserved from TypeScript source */): Unit {
    TODO("Port runtime function handleMessageEnd from src/agents/pi-embedded-subscribe.handlers.messages.ts")
}
