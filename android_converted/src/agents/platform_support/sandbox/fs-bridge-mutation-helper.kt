...
// Source: src/agents/sandbox/fs-bridge-mutation-helper.ts
// TODO(openclaw-kotlin-port): Mechanical Phase 3 source-to-source translation.
// The goal here is structural fidelity, not compile-ready Kotlin.
// TODO: Replace placeholder imports/runtime shims during platform integration.

// TODO(openclaw-kotlin-port): import { PATH_ALIAS_POLICIES } from "../../infra/path-alias-guards.js";
// TODO(openclaw-kotlin-port): import type {
// TODO(openclaw-kotlin-port):   PathSafetyCheck,
// TODO(openclaw-kotlin-port):   PinnedSandboxDirectoryEntry,
// TODO(openclaw-kotlin-port):   PinnedSandboxEntry,
// TODO(openclaw-kotlin-port): } from "./fs-bridge-path-safety.js";
// TODO(openclaw-kotlin-port): import type { SandboxFsCommandPlan } from "./fs-bridge-shell-command-plans.js";

val SANDBOX_PINNED_MUTATION_PYTHON = [
  "import errno",
  "import os",
  "import secrets",
  "import stat",
  ...
  "else:",
  "    raise RuntimeError('Any? sandbox mutation operation: ' + operation)",
].join("\n")

fun buildPinnedMutationPlan(params: {
  args: String[]
...
fun buildPinnedWritePlan(params: {
...
fun buildPinnedMkdirpPlan(params: {
  check: PathSafetyCheck
...
fun buildPinnedRemovePlan(params: {
  check: PathSafetyCheck
  pinned: PinnedSandboxEntry
  recursive?: Boolean
  force?: Boolean
...
fun buildPinnedRenamePlan(params: {
