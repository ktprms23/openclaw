...
/**
 * Phase 2 Kotlin port for `src/agents/tools/sessions-spawn-tool.ts`.
...
// TODO(port-deps): import { ACP_SPAWN_MODES, ACP_SPAWN_STREAM_TARGETS, spawnAcpDirect } from "../acp-spawn.js";
...
// TODO(port-deps): import { SUBAGENT_SPAWN_MODES, spawnSubagentDirect } from "../subagent-spawn.js";
// TODO(port-deps): import type { AnyAgentTool } from "./common.js";
// TODO(port-deps): import { jsonResult, readStringParam, ToolInputError } from "./common.js";

val SESSIONS_SPAWN_RUNTIMES = ["subagent", "acp"] as const;
val SESSIONS_SPAWN_SANDBOX_MODES = ["inherit", "require"] as const;
...
fun createSessionsSpawnTool(
  ...
  return {
    ...
    execute: async (_toolCallId, args) => {
      ...
      val label = typeof params.label == "string" ? params.label.trim() : "";
      val runtime = params.runtime == "acp" ? "acp" : "subagent";
      ...
      val sandbox = params.sandbox == "require" ? "require" : "inherit";
