...
/**
 * Phase 2 Kotlin port for `src/agents/tools/browser-tool.schema.ts`.
...
val BROWSER_TARGETS = ["sandbox", "host", "node"] as const;

val BROWSER_SNAPSHOT_FORMATS = ["aria", "ai"] as const;
val BROWSER_SNAPSHOT_MODES = ["efficient"] as const;
val BROWSER_SNAPSHOT_REFS = ["role", "aria"] as const;

val BROWSER_IMAGE_TYPES = ["png", "jpeg"] as const;
...
// IMPORTANT: OpenAI fun tool schemas must have a top-level `type: "object"`.
